        ...
        <div className="container">
          ...
          <div className="row mt-3">
            <div className="col-lg-4 col-sm-12 col-md-3">
              <p>
                ¿Tiene planta de tratamiento de agua <br /> para el consumo
                humano?
              </p>
            </div>
          ...
          <div className="row mt-2">
            <div className="col-lg-5 col-md-5 col-sm-12">
              <div className="check_d">
                <table
                  className="table table-bordered text-center tablesr"
                  style={{ backgroundColor: "#ede9e3" }}
                >
                  <thead>
                    <tr
          ...
          <div className="row mt-3">
            ...
            <div className="col-lg-8 col-md-8 col-sm-12 mt-3">
              ...
              <small className="mt-1">
                * Espacio del ciudadano para incluir documentación adicionar de
                ser requerido
              </small>
            </div>
          </div>
